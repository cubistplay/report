...
- base: `main` / `2796423a6e4623697cf2c612ab1f5d07b7b17e88`
- Red 테스트: `760918a2498413fe374370f2c03e84af74538528`
  `test(implement-10): specify memory lifecycle policy`
- 최초 PR 및 최종 head: `f026c9825ec2123ad506a4b107bcf7ebb237aa57`
  `refactor(implement-10): centralize memory lifecycle policy`
- 최종 `main`: `f026c9825ec2123ad506a4b107bcf7ebb237aa57`
...
변경 파일은 `brainwash/memory/ledger.py`, `tests/test_memory_ledger.py`입니다. 231줄 안에서 lifecycle
