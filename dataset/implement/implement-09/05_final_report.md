...
- base: `main` / `276f08839241196df264e1e7cb6276f28c73e2cd`
- Red 테스트: `790f7a427cad51e373b932e27ef7fee90a828e25`
  `test(implement-09): specify memory match strategies`
- 최초 PR 및 최종 head: `2796423a6e4623697cf2c612ab1f5d07b7b17e88`
  `refactor(implement-09): separate memory match strategies`
- 최종 `main`: `2796423a6e4623697cf2c612ab1f5d07b7b17e88`
...
변경 파일은 `brainwash/algorithms/memory_edit.py`, `tests/test_memory_edit_runtime.py`입니다. 340줄 안에서
